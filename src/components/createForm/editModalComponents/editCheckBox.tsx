...
export default function EditCheckBox({
  ...
  const [defaultValue, setDefaultValue] = useState(itemD.checkBoxDefaultValue!);
  ...
  return (
    <form
      id="editItemD"
      className="w-full h-96 flex flex-col pb-5 space-y-2 overflow-auto"
    >
      ...
      <div className="mt-2 flex items-center justify-start space-x-2 text-lg">
        ...
        />
        <label className="text-lg font-bold" htmlFor="defaultValue">
          Default Value
        </label>
      </div>
      <div className="mt-2 flex items-center justify-start space-x-2 text-lg">
      ...
      <div className="w-full flex items-center justify-end space-x-2 pr-2">
        <div
          ...
          onClick={() => {
            ...
            setDefaultValue(itemD.checkBoxDefaultValue!);
